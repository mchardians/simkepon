...
class UserDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function($data) {
                return (
                    ...
                    // .'<button class="btn btn-action btn-danger btn-info" id="'.$data->id.'"><i class="fas fa-key"></i></button>'
                );
            })
            ->addIndexColumn();
    }
    ...
    {
        return $model->query()->select(['name', 'email', 'created_at'])->where('role', '=', 'walisantri');
    }
