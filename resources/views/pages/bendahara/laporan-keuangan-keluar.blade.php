<x-vertical-layout title="Laporan">
    <x-slot name="css">
                    ...
                    buttons: [
                        {
                            ...
                            text: 'PDF',
                            title: '',
                            filename: `Laporan Pengeluaran ${new Date().getDate() < 10 ? `0${new Date().getDate()}` : new Date().getDate()}-${new Date().getMonth() + 1 < 10 ? `0${new Date().getMonth() + 1}` : new Date().getMonth() + 1}-${new Date().getFullYear()}`,
                        },
                        {
                            extend: 'excelHtml5',
                            class: 'buttons-excel',
